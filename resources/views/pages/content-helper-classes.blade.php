...
<section id="borders" class="card">
  ...
  <div class="card-content">
    ...
    <div class="card-body">
      <div class="card-text my-1">
        <h6 class="my-1">Remove border</h6>
    ...
    <div class="card-body">
      <div class="card-text my-1">
        <h6 class="my-1">Border widths</h6>
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td>Add colored border to all side. ColorName can be primary, success, danger, warning, info, secondary
              light, dark, white.</td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="card-body">
      <div class="card-text my-1">
        <h6 class="my-1">Border-radius</h6>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Remove border corner from the all side.</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="card-body">
      <div class="card-text my-1">
        <h6 class="my-1">Remove border radius</h6>
  ...
  <div class="card-content">
    ...
    <div class="card-body">
      <div class="card-text">
        ...
        <h6 class="my-1">Common display values</h6>
    ...
    <div class="card-body">
      <div class="card-text">
        ...
        <h6 class="my-1">Hiding Elements</h6>
        <p>For faster mobile-friendly development, use responsive display classes for showing and hiding elements by
          device. Avoid creating entirely different versions of the same site, instead hide element responsively for
          each screen size.</p>
        <p>To hide elements simply use the <code class="highlighter-rouge">.d-none</code> class or one of the <code
            class="highlighter-rouge">.d-{sm,md,lg,xl}-none</code> classes for any responsive screen variation.</p>
        <p>To show an element only on a given interval of screen sizes you can combine one <code
            class="highlighter-rouge">.d-*-none</code> class with a <code class="highlighter-rouge">.d-*-*</code> class,
          for example <code class="highlighter-rouge">.d-none.d-md-block.d-xl-none</code> will hide the element for all
        ...
        <h6 class="my-1">Display in print</h6>
  ...
  <div class="card-content">
    <div class="card-body">
      <div class="card-text">
        ...
        <h6 class="my-1">Aspect ratios</h6>
...
<section id="flex" class="card">
  ...
  <div class="card-content">
    ...
    <div class="card-body">
      <div class="card-text">
        <p class="bd-lead">Quickly manage the layout, alignment, and sizing of grid columns, navigation, components, and
          ...
          necessary.</p>
        <h6 id="enable-flex-behaviors" class="my-1">Enable flex behaviors</h6>
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="direction" class="my-1">Direction</h6>
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="justify-content" class="my-1">Justify content</h6>
        <p>Use <code class="highlighter-rouge">justify-content</code> utilities on flexbox containers to change the
          alignment of flex items on the main axis (the x-axis to start, y-axis if <code
            ...
            class="highlighter-rouge">start</code> (browser default), <code class="highlighter-rouge">end</code>,
          <code class="highlighter-rouge">center</code>, <code class="highlighter-rouge">between</code>, or <code
        ...
        <ul>
          ...
          <li><code class="highlighter-rouge">.justify-content-{breakpoint}-{start/end/center/between/around}</code>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="align-items" class="my-1">Align items</h6>
        ...
        <ul>
          ...
          <li><code class="highlighter-rouge">.align-items-{breakpoint}-{start/end/center/baseline/stretch}</code>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="align-self" class="my-1">Align self</h6>
        <p>Use <code class="highlighter-rouge">align-self</code> utilities on flexbox items to individually change
          their
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="align-self-margin" class="my-1">Auto margins</h6>

        <p>Flexbox can do some pretty awesome things when you mix flex alignments with auto margins. Shown below are
          three examples of controlling flex items via auto margins: default (no auto margin), pushing two items to
          the
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="with-align-items" class="my-1">With align-items</h6>
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="order" class="my-1">Order</h6>

        <p>Change the <em>visual</em> order of specific flex items with a handful of <code
            class="highlighter-rouge">order</code> utilities. We only provide options for making an item first or
          last,
          as well as a reset to use the DOM order. As <code class="highlighter-rouge">order</code> takes any integer
          value (e.g., <code class="highlighter-rouge">5</code>), add custom CSS for any additional values needed.</p>
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 id="align-content" class="my-1">Align content</h6>
        <p>Use <code class="highlighter-rouge">align-content</code> utilities on flexbox containers to align flex
          items
          <em>together</em> on the cross axis. Choose from <code class="highlighter-rouge">start</code> (browser
          default), <code class="highlighter-rouge">end</code>, <code class="highlighter-rouge">center</code>, <code
            class="highlighter-rouge">between</code>, <code class="highlighter-rouge">around</code>, or <code
            class="highlighter-rouge">stretch</code>. To demonstrate these utilities, we’ve enforced <code
            class="highlighter-rouge">flex-wrap: wrap</code> and increased the number of flex items.</p>
        ...
        <ul>
          ...
          <li><code class="highlighter-rouge">.align-content-{breakpoint}-{start/end/center/around/stretch}</code>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="card-content">
    ...
    <div class="card-body">
      <div class="card-text">
        ...
        <h6 id="float-responsive" class="my-1">Responsive</h6>
      ...
      <div class="card-text">
        ...
        <div class="bd-example">
          <h1 class="text-hide my-2"
            style="background-image: url('{{asset('images/logo/logo.png')}}'); width: 30px; height: 26px;">
            Bootstrap</h1>
        </div>
        <pre><code class="language-html">
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td>Set content fixed height in pixel of selected size where size can be 50, 100, 150, 200, 250,
              300, 350,
              400, 450, 500, 550, 600, 650, 700, 750 and 800. i.e <code>.height-50</code></td>
          </tr>
          <tr>
            <td><code>.height-{size}-per</code></td>
            <td>Set content fixed height in percentage of selected size where size can be 5%, 10%, 15%, 20%,
              25%, 30%,
              35%, 40%, 45%, 50%, 55%, 60%, 65%, 70%, 75% and 80%. i.e <code>.height-5-per</code></td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <div class="card-content">
    <div class="card-body">
      <div class="card-text">
        ...
        <h6 class="my-1">How it works</h6>
        <p>Assign responsive-friendly <code class=" highlighter-rouge">margin</code> or <code
            class="highlighter-rouge">padding</code> values to an element or a subset of its sides with shorthand
          classes. Includes support for individual properties, all properties, and vertical and horizontal properties.
          Classes are built from a default Sass map ranging from <code class="highlighter-rouge">.25rem</code> to <code
            class="highlighter-rouge">3rem</code>.</p>
        <h6 class="my-1">Notation</h6>
        <p>Spacing utilities that apply to all breakpoints, from <code class=" highlighter-rouge">xs
          </code> to <code class="highlighter-rouge">xl</code>, have no breakpoint abbreviation in them. This is
          because
          those classes
        ...
        <ul>
          ...
          <li><code class="highlighter-rouge">r</code> - for classes that set <code
              class="highlighter-rouge">margin-right</code> or <code class="highlighter-rouge">padding-right</code>
          </li>
        ...
        <ul>
          <li><code class="highlighter-rouge">0</code> - for classes that eliminate the <code
              class="highlighter-rouge">margin</code> or <code class="highlighter-rouge">padding</code> by setting it
            to
    ...
    <div class="card-body">
      <div class="card-text">
        <h6 class="my-1">Horizontal centering</h6>
