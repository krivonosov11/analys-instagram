    ...
    <div class="col-xl-6 col-lg-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <p>
              Use class <code>.rounded-circle</code> with your <code>&lt;img&gt;</code> tag to shape image as a circle.
              use class <code>.text-right</code> with <code>.media-body</code> for right aligned text
            </p>
            <div class="media-list">
              <div class="media">
      ...
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div class="media-list media-bordered">
              <div class="media">
                <a class="align-self-start pr-1" href="#">
              ...
              <div class="media">
                <a class="pr-1 align-self-center" href="#">
                  <img src="{{asset('images/portrait/small/avatar-s-1.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
              ...
              <div class="media">
                <a class="pr-1 align-self-end" href="#">
                  <img src="{{asset('images/portrait/small/avatar-s-16.jpg')}}" alt="Generic placeholder image"
                    height="64" width="64" />
                </a>
                <div class="media-body">
