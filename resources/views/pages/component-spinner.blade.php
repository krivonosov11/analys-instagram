  ...
  <div class="row match-height">
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <p>Use class <code>.spinner-border</code> for a lightweight loading indicator.</p>
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <p>For customizing spinner with different colored options, use <code>.text-{colorName}</code> along with <code>.spinner-border</code>.
  ...
  <div class="row match-height">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <p>For colored growing spinner, use <code>.text-{color}</code> along with <code>.spinner-grow</code>.</p>
  ...
  <div class="row match-height">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <p>You can also use <code>.float-{left | right}</code> to place your spinner left or right side.</p>
            <div class="clearfix">
  ...
  <div class="row match-height">
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <p>You can also use <code>.text-{side}</code> as a wrapper class of <code>.spinner-border</code>for the spinner's placement.</p>
